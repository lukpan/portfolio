...
- **Scale without losing coherence:** Manage 600+ content pages across 9 learning paths while maintaining consistency
...
Prerequisites span learning paths, creating a knowledge graph rather than isolated silos. Example: The "Integration Patterns" module requires foundational knowledge from both "Developer Essentials" and "Business Structure." This reinforces that real-world implementations require understanding both technical architecture and business logic.
...
Learning Path (9 paths) → Module (40+ modules) → Page (600+ pages). This hierarchy provides natural scaffolding. Each tier represents a cognitive "chunk" of knowledge, making vast content manageable.
...
Managing 600+ pages created risk of formatting inconsistencies, terminology mismatches, and varying technical accuracy.
...
Collaborated with 15+ subject matter experts across Product, Engineering, and Solutions teams to develop technically accurate content. Established efficient review workflows that balanced SME input with rapid iteration, enabling delivery of 40+ modules across 3 years.
...
- **40+ individual modules** with standardized structure
- **600+ content pages** covering complete platform capabilities
...
**Maintainability:**  
TypeScript configuration prevents registration errors through type safety. Instruction files enforce consistency across 600+ pages without manual review overhead.
...
📄 [Configuration system](https://github.com/commercetools/commercetools-docs/blob/main/packages/next-docs/src/components/CustomPages/LearningHomepage/learning-catalogue-config.ts) - TypeScript learning path registry  
📄 [Sample learning path](https://github.com/commercetools/commercetools-docs/tree/main/websites/learning-model-your-product-catalog) - Administrator-focused path with 7 modules  
📄 [Sample module structure](https://github.com/commercetools/commercetools-docs/tree/main/websites/learning-model-your-product-catalog/src/content/product-modeling) - Complete module with overview, content pages, assessment  
📄 [Component library](https://github.com/commercetools/commercetools-docs/tree/main/packages/next-docs/src/components/self-learning) - Specialized learning UI components  
🎬 **Explore live learning paths** - [docs.commercetools.com/training](https://docs.commercetools.com/training)
