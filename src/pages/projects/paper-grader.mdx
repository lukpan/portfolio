...
audience: 'University faculty in education departments grading reflective writing assignments'
...
University educators face an unsustainable grading workload. A single assignment requiring detailed feedback takes 30-45 minutes per student. For a cohort of 90 students, this translates to 60-80 hours of manual marking—often completed over weekends and breaks.
...
- **Teaching assistants** cost $30-40/hour and still face consistency challenges
...
The system auto-detects file type and routes to the appropriate converter. This seemingly technical choice had pedagogical impact—students could focus on content, not formatting compliance.
...
Faculty spot-check 10-15 random papers, make any needed edits, then export grades to their university gradebook.
