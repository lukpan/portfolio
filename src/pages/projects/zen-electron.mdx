...
role: 'Lead Instructional Designer & Content Strategist'
...
deliverables: ['Integrated case study across 40+ modules', 'Scenario-based assessment system', 'AI context documentation']
heroImage: '/portfolio/images/zen-electron-hero.png'
...
- Maintain consistency across 600+ pages of content developed over 3 years
...
**Module 1 (Stores and Channels):**  
"Zen Electron operates two distinct brands from a single Project: Electronics High Tech (220 stores) and Zenith Living (102 stores). Both brands require completely separate customer data and merchant center access..."

**Module 3 (Product Modeling):**  
"Electronics High Tech and Zenith Living share a catalog of 46,000 products, but Zenith Living needs premium product descriptions for their white-glove service customers. How do you enable brand-specific descriptions without duplicating the entire catalog?"

**Module 7 (Checkout Implementation):**  
"**Quiz Question**: During a flash sale, Zen Electron customers were charged twice for the same order. Which pattern prevents this?"
...
- **Scale:** 9 learning paths, 40+ modules, 600+ pages of content
...
- **Single source of truth prevents drift.** Maintaining canonical case study documentation across 3 years and 600+ pages requires explicit reference documents. AI integration automates consistency checking.
...
📄 [Case study documentation](https://github.com/commercetools/commercetools-docs/tree/main/.github/prompts/learning-zen-electron-case-study-summary.md) - Canonical case study reference (200+ lines)  
📄 [Learning content examples](https://github.com/commercetools/commercetools-docs/tree/main/websites/learning-implement-checkout/src/content) - Integrated scenarios across modules  
📄 [Assessment examples](https://github.com/commercetools/commercetools-docs/tree/main/websites/learning-implement-carts-and-shopping-lists/src/content/manage-signups-and-signins/learning-check.mdx) - Scenario-based quiz questions
